...
export default create({
  ...
  brandUrl: '/', // imgをクリックした場合の遷移先
  brandImage: '../src/assets/github.svg', // 左上の画像
  ...
  appContentBg: '#f4f7f7', // 下部のタブパネルエリア背景
  appPreviewBg: '#ffffff', // プレビューエリア背景
  appBorderColor: '#dddddd', // ボーダーカラー
